...
if [[ $OPTION = "start" ]]; then
  ...
  CRONENV="$CRONENV AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID"
  CRONENV="$CRONENV AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY"
  CRONENV="$CRONENV AWS_DEFAULT_REGION=$AWS_DEFAULT_REGION"
